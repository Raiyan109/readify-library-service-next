...
export default function Signup() {
    ...
    return (
        <div>
            {/* <!-- component --> */}
            <section id="contact" class="relative w-full min-h-screen bg-black text-primary">
                <h1 class="text-4xl p-4 font-bold tracking-wide">
                    Sign up
                </h1>
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-secondary h-32 w-full"></div>
                ...
                <div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
                    ...
                    <div class="w-full md:w-1/2 p-5 md:px-0 mx-5">
                        <div class="bg-gray-900 border border-secondary w-full lg:w-1/2 h-full p-5 pt-8">
                            <h3 class="text-2xl font-semibold mb-5">
                                Sign up using social media
                            </h3>
                            {/* <!-- list --> */}
                            <div class="flex flex-col gap-3">
                                <a href="#" class="flex items-center hover:text-black hover:bg-primary p-2">
                    ...
                    {/* <!-- Contact Me --> */}
                    <form onSubmit={handleSubmit} class="w-full md:w-1/2 border border-secondary p-6 bg-gray-900">
                        ...
                        <div>
                            <div class="flex flex-col mb-3">
                                ...
                                <input
                                    type="text"
                                    class="px-3 py-2 bg-gray-800 border border-gray-900 focus:border-secondary focus:outline-none focus:bg-gray-800 focus:text-primary"
                                    autocomplete="off"
                        ...
                        <div class="w-full pt-3">
                            <button type="submit" class="w-full bg-gray-900 border border-secondary px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-secondary hover:text-black text-xl cursor-pointer">
                                Sign up
                            </button>
                        </div>
                    </form>
